...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="GA or fuzzy match on gap-analysis" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/gap-analysis/workflow.yaml">[GA] Run Gap Analysis - audit story tasks against codebase (useful for sprint health checks)</item>
    <item cmd="AEP or fuzzy match on autonomous-epic" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/autonomous-epic/workflow.yaml">[AEP] Autonomous Epic Processing - create and develop all stories in an epic automatically</item>
