...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="SDS or fuzzy match on super-dev-story" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/super-dev-story/workflow.yaml">[SDS] Execute Super-Dev Story workflow (enhanced quality with post-dev validation + auto code review)</item>
    <item cmd="GA or fuzzy match on gap-analysis" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/gap-analysis/workflow.yaml">[GA] Run Gap Analysis - audit story tasks against codebase without starting development</item>
    <item cmd="AE or fuzzy match on autonomous-epic" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/autonomous-epic/workflow.yaml">[AE] Autonomous Epic Processing - create and develop all stories in an epic automatically</item>
    <item cmd="PA or fuzzy match on push-all" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/push-all/workflow.yaml">[PA] Push-All - stage, commit, and push all changes with safety validation</item>
